#!/usr/bin/env python3
"""
Validate KOSEI JSON sources and emit GitHub Actions annotations for failures.
"""
...
from kosei_generate import load_json


CONTENT_FILE = ROOT / "workflow_content_v2.json"
...
def main() -> int:
    content, parse_errors = parse_with_location(CONTENT_FILE, "workflow_content_v2.json")
    ...
    print("Validation passed: workflow_content_v2.json and workflow_control.json")
    return 0
